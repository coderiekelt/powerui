...
namespace JavaScript.Compiler
{
	...
	internal abstract class Token
	{
		...
		/// <summary>
		/// If this token is used by an operator, the operator it represents (postfix).
		/// </summary>
		public Operator PostfixOperator;
		
		/// <summary>
		/// If this token is used by an operator, the operator it represents (prefix).
		/// </summary>
		...
		public virtual Statement ParseNoNewContext(Parser parser){
			return parser.ParseLabelOrExpressionStatement();
		}
