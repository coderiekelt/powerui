...
namespace JavaScript.Compiler
{
	...
	internal class BinaryExpression : OperatorExpression
	{
		...
		private Prototype ResolvedPrototype;
		...
		public override object Evaluate()
		{
			...
			switch (this.OperatorType)
			{
				...
				{
					var leftPrimitive = TypeConverter.ToPrimitive(left);
					var rightPrimitive = TypeConverter.ToPrimitive(right);
				...
				case OperatorType.Add:
					{
						...
						if (lhs == typeof(object) || lhs == typeof(ObjectInstance) ||
							rhs == typeof(object) || rhs == typeof(ObjectInstance))
		...
		private void GenerateAdd(ILGenerator generator, OptimizationInfo optimizationInfo)
		{
			...
			if (PrimitiveTypeUtilities.IsString(leftType) || PrimitiveTypeUtilities.IsString(rightType))
			{
				...
				EmitConversion.ToPrimitive(generator, leftType);
				...
				else
				{
					...
					EmitConversion.ToPrimitive(generator, rightType);
			...
			else if (leftType != typeof(object) && leftType != typeof(Extendable) &&
				rightType != typeof(object) && rightType != typeof(Extendable))
			{
		...
		private void GenerateInstanceOf(ILGenerator generator, OptimizationInfo optimizationInfo)
		{
			...
			generator.LoadInt32(1);
			generator.LoadStringOrNull(optimizationInfo.SourcePath);
