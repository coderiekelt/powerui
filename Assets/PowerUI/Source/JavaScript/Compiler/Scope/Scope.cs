...
namespace JavaScript.Compiler
{
	...
	public abstract class Scope
	{
		...
		/// <summary>True if this is the global scope.</summary>
		...
		/// <summary>Gets the scope chain with the given number of scopes. Includes this scope at index 0.</summary>
		public Scope[] GetChain(int count){
			
			Scope[] set=new Scope[count];
			Scope current=this;
