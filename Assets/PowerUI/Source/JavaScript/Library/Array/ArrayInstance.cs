...
namespace JavaScript
{
	...
	public partial class JSArray
	{
		...
		internal JSArray(uint length, uint capacity)
		{
			if (length > capacity)
		...
		internal JSArray(object[] elements)
		{
			if (elements == null)
		...
		/// <param name="length"> The initial value of the length property. </param>
		private JSArray(SparseArray sparseArray, uint length)
		{
			if (sparseArray == null)
		...
		/// </summary>
		public static int get_Length(ScriptEngine engine,JSArray thisObj) // Note that they must *both* either have or not have engine!
		{
			return (int)thisObj.length;
		}
		
		public static void set_Length(ScriptEngine engine,JSArray thisObj,int value)
		{
		...
		public object this[string index]
		{
			get
			{
				...
				if(intIndex==uint.MaxValue){
					...
					if(!lookup.TryGetValue(index,out result)){
		...
		*/
		...
		/// <summary>Reads from the lookup.</summary>
		[JSProperties(Hidden=true)]
		internal object GetLookup(uint index){

			object ele;
			if(!lookup.TryGetValue(index.ToString(),out ele)){
				return Undefined.Value;
			}
		...
		public static JSArray Concat(ScriptEngine engine,JSArray thisObj, params object[] items)
		{
			...
			foreach (object item in items)
				if (item is JSArray)
				{
					length += ((JSArray)item).length - 1;
					if (((JSArray)item).dense == null)
						dense = false;
				}
						...
						if (array.denseMayContainHoles == true && array.lookup != null)
						{
							...
							for (uint i = 0; i < array.length; i++){
								if (array.dense[i] == null){
									result[index + i] = array.GetLookup(i);
								}
							}
						}
			...
			else
			{
					...
					if (item is JSArray)
					{
						...
						if (array.dense != null)
						{
							...
							if (array.lookup != null)
							{
								...
								for (uint i = 0; i < array.length; i++)
									if (array.dense[i] == null)
										result[(uint)index + i] = array.GetLookup(i);
							}
						}
						else
						{
				...
				return new JSArray(result, length);
			}
		}
		...
		public static string Join(ScriptEngine engine,JSArray thisObj, string separator)
		{
			...
			try
			{
				...
				for (uint i = 0; i < arrayLength; i++)
				{
					...
					if (element != null && element != Undefined.Value)
		...
		public static object Pop(JSArray thisObj)
		{
		...
		public static double Push(ScriptEngine engine,JSArray thisObj, params object[] items)
		{
			// If the "this" object is an array, use the fast version of this method.
		...
		public static JSArray Reverse(JSArray thisObj)
		{
			// Get the length of the array.
			uint arrayLength = GetLength(thisObj);
		...
		public static object Shift(ScriptEngine engine,JSArray thisObj)
		{
			// Get the length of the array.
			uint arrayLength = GetLength(thisObj);
		...
		public static JSArray Slice(ScriptEngine engine,JSArray thisObj, int start, int end)
		{
			...
			if (end <= start)
				return JSArray.New(engine,new object[0]);
			...
			return JSArray.New(engine,result);
		}
		...
		public static JSArray Sort(ScriptEngine engine,JSArray thisObj, FunctionInstance comparisonFunction)
		{
			// Get the length of the array.
			uint arrayLength = GetLength(thisObj);
		...
		public static JSArray Splice(ScriptEngine engine,JSArray thisObj, int start, int deleteCount, params object[] items)
		{
			// Get the length of the array.
			uint arrayLength = GetLength(thisObj);
			...
			return JSArray.New(engine,deletedItems);
		}
		...
		public static uint Unshift(ScriptEngine engine,JSArray thisObj, params object[] items)
		{
			// If the "this" object is an array and the array is dense, use the fast version of this method.
			var array = thisObj; // as JSArray;
			if (array != null && array.dense != null)
			{
				...
				if (array.denseMayContainHoles == true && array.lookup != null)
				{
					...
					for (uint i = 0; i < array.length; i++)
						if (array.dense[i] == null)
							array.dense[i] = array.GetLookup(i);
				}
		...
		public static string ToLocaleString(ScriptEngine engine,JSArray thisObj)
		{
			// Get the length of the array.
			...
			try
			{
				...
				for (uint i = 0; i < arrayLength; i++)
				{
					...
					if (obj2!=null){
						...
						result.Append(obj2.CallMemberFunctionOn(element,"toLocaleString",false));
		...
		public static string ToString(ScriptEngine engine,JSArray thisObj)
		{
		...
		public static int IndexOf(ScriptEngine engine,JSArray thisObj, object searchElement, int fromIndex)
		{
			// Get the length of the array.
			uint arrayLength = GetLength(thisObj);
		...
		/// <returns> The index of the given search element in the array, or <c>-1</c> if the
		/// element wasn't found. </returns>
		public static int LastIndexOf(ScriptEngine engine,JSArray thisObj, object searchElement)
		{
		...
		/// <returns> The index of the given search element in the array, or <c>-1</c> if the
		/// element wasn't found. </returns>
		public static int LastIndexOf(ScriptEngine engine,JSArray thisObj, object searchElement, int fromIndex)
		{
			// Get the length of the array.
			uint arrayLength = GetLength(thisObj);
		...
		public static bool Every(ScriptEngine engine,JSArray thisObj, FunctionInstance callbackFunction, object context)
		{
		...
		public static bool Some(ScriptEngine engine,JSArray thisObj, FunctionInstance callbackFunction, object context)
		{
			// callbackFunction must be a valid function.
			if (callbackFunction == null)
				throw new JavaScriptException(engine, "TypeError", "Invalid callback function");
		...
		public static JSArray Map(ScriptEngine engine,JSArray thisObj, FunctionInstance callbackFunction, object context)
		{
			...
			var resultArray = new JSArray(arrayLength, arrayLength);
		...
		public static object Find(ScriptEngine engine,JSArray thisObj, FunctionInstance callbackFunction, object context)
		{
			// callbackFunction must be a valid function.
			if (callbackFunction == null)
				throw new JavaScriptException(engine, "TypeError", "Invalid callback function");
		...
		public static JSArray Filter(ScriptEngine engine,JSArray thisObj, FunctionInstance callbackFunction, object context)
		{
			// callbackFunction must be a valid function.
			if (callbackFunction == null)
				throw new JavaScriptException(engine, "TypeError", "Invalid callback function");
		...
		/// function. </returns>
		public static object Reduce(ScriptEngine engine,JSArray thisObj, FunctionInstance callbackFunction, object initialValue)
		{
			// callbackFunction must be a valid function.
			if (callbackFunction == null)
				throw new JavaScriptException(engine, "TypeError", "Invalid callback function");
		...
		/// <returns> The accumulated value returned from the last invocation of the callback
		/// function. </returns>
		public static object ReduceRight(ScriptEngine engine,JSArray thisObj, FunctionInstance callbackFunction, object initialValue)
		{
			// callbackFunction must be a valid function.
			if (callbackFunction == null)
				throw new JavaScriptException(engine, "TypeError", "Invalid callback function");
		...
		private static uint GetLength(JSArray thisObj)
		{
		...
		private static void SetLength(ScriptEngine engine,JSArray thisObj, uint value)
		{
		...
		private static void QuickSort(JSArray array, OnCompare comparer, uint start, uint end)
		{
			if (end - start < 30)
			{
		...
		/// <param name="start"> The first index in the range. </param>
		/// <param name="end"> The last index in the range. </param>
		private static void InsertionSort(JSArray array, OnCompare comparer, uint start, uint end)
		{
		...
		private static void Swap(JSArray array, uint index1, uint index2)
		{
		...
		/// <summary>
		/// Creates a new JSArray instance.
		/// </summary>
		public static JSArray New(ScriptEngine engine)
		{
			return new JSArray(0, 10);
		}
		...
		public static JSArray New(ScriptEngine engine,object[] elements)
		{
		...
		/// <summary>
		/// Creates a new JSArray instance and initializes the contents of the array.
		/// Called when the new expression is used on this object, e.g. var x = new Array(length).
		/// </summary>
		/// <param name="elements"> The initial elements of the new array. </param>
		public static JSArray OnConstruct(ScriptEngine engine,params object[] elements)
		{
			if (elements.Length == 1)
			{
				if (TypeUtilities.IsNumeric(elements[0]))
				{
					...
					if (specifiedLength != (double)actualLength)
						throw new JavaScriptException(engine, "RangeError", "Invalid array length");
					return new JSArray(actualLength, actualLength);
				}
			}
		...
		/// <summary>
		/// Tests if the given value is an JSArray instance.
		/// </summary>
		/// <param name="value"> The value to test. </param>
		/// <returns> <c>true</c> if the given value is an JSArray instance, <c>false</c> otherwise. </returns>
