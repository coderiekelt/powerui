...
namespace JavaScript
{
	...
	public partial class MethodGroup
	{
		...
		/// <summary>
		/// A static method used to disambiguate which method to output.
		/// </summary>
		public MethodInfo Disambiguation;
		...
		public object Invoke(object thisObj,object[] parameters)
		{
			...
			if(method==null){
				throw new Exception("Could not match your parameters to a suitable method.");
			}
