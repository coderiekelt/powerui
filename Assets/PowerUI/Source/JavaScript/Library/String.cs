...
namespace JavaScript
{
	...
	public static class String
	{
		...
		public static JSArray Split(ScriptEngine engine, string thisObj, object separator, double limit)
		{
			if(limit==0)
				limit=uint.MaxValue;
		...
		/// <param name="limit"> The maximum number of array items to return.  Defaults to unlimited. </param>
		/// <returns> An array containing the split strings. </returns>
		internal static JSArray Split(ScriptEngine engine,string thisObj, RegExp regExp, uint limit)
		{
			if(limit==0)
				limit=uint.MaxValue;
		...
		/// <param name="limit"> The maximum number of array items to return.  Defaults to unlimited. </param>
		/// <returns> An array containing the split strings. </returns>
		internal static JSArray Split(ScriptEngine engine, string thisObj, string separator, uint limit)
		{
			if(limit==0)
				limit=uint.MaxValue;
			...
			return JSArray.New(engine,splitStrings);
		}
