...
namespace JavaScript
{
	...
	public class TypedArray
	{
		...
		{
			JSArray arr=(iterableObj as JSArray);
			
			if(arr!=null)
			{
				return JSArray.get_Length(null,arr);
			}
		...
		/// <summary>
		/// Gets an enumerable list of every property value associated with this object.
		/// </summary>
		...
		/// </summary>
		[JSProperties(Hidden=true)]
		public IEnumerator<KeyValuePair<string,object>> PropertyPairs{
			get{
				// Enumerate array values.
				for (int i = 0; i < ByteLength; i+=BYTES_PER_ELEMENT)
					yield return new KeyValuePair<string,object>(i.ToString(),Get(i));
			}
		}
		...
		/// </summary>
		[JSProperties(Hidden=true)]
		public IEnumerator<string> PropertyNames{
			get{
