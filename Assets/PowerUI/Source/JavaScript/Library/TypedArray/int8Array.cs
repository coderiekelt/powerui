...
namespace JavaScript
{
	...
	public class Int8Array : TypedArray
	{
		...
		{
			return (buffer[index + ByteOffset]-128);
		}
		...
		protected override void Set(int index,object value)
		{
			...
			buffer[index + ByteOffset]=(byte)(((sbyte)value)+128);
		}
		...
		public sbyte this[int index]{
			get{
				return (sbyte)(buffer[index + ByteOffset]-128);
			}
			set{
				buffer[index + ByteOffset]=(byte)(value+128);
			}
		}
