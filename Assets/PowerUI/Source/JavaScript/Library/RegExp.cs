...
namespace JavaScript
{
	...
	public partial class RegExp
	{
		...
		public object Exec(ScriptEngine engine,string input)
		{
			...
			var result = JSArray.New(engine,array);
		...
		public object Match(ScriptEngine engine,string input)
		{
			...
			return JSArray.New(engine,matchValues);
		}
		...
		public JSArray Split(ScriptEngine engine,string input)
		{
		...
		public JSArray Split(ScriptEngine engine,string input, uint limit)
		{
			...
			while (match.Success == true)
			{
				...
				if (results.Count >= limit)
					return JSArray.New(engine,results.ToArray());
