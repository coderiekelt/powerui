...
namespace JavaScript{
	...
	/// <summary>
	/// Represents functions and properties within the standard global scope.
	/// They get imported to the global prototype.
	/// </summary>
	...
	public class Window{
		...
		/// <summary>Read-only in ECMAScript 5.</summary>
		public static Undefined undefined=JavaScript.Undefined.Value;
		...
		/// <remarks> Leading whitespace is ignored.  Parsing continues until the first invalid
		/// character, at which point parsing stops.  No error is returned in this case. </remarks>
		public static double ParseInt(string input, double radix)
		{
