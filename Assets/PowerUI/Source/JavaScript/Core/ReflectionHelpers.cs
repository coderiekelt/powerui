...
namespace JavaScript{
	...
	internal static class ReflectionHelpers
	{
		...
		internal static ConstructorInfo JSFunctionAttribute_Constructor;
		...
		static ReflectionHelpers()
		{
			...
			TypeConverter_ToPrimitive = GetStaticMethod(typeof(TypeConverter), "ToPrimitive", typeof(object));
			...
			RegExp_Construct = GetStaticMethod(typeof(JavaScript.RegExp), "OnConstruct", typeof(ScriptEngine), typeof(object), typeof(string));
			Array_New = GetStaticMethod(typeof(JSArray), "New", typeof(ScriptEngine),typeof(object[]));
			...
			JSFunctionAttribute_Constructor = GetConstructor(typeof(JSFunctionAttribute),typeof(int));
...
#if DEBUG
			// When using Reflection Emit, all calls into our dll are cross-assembly and thus
			// must be public.
