...
namespace JavaScript{
	...
	internal static class NumberParser
	{
		...
		internal static double ParseFloat(string input)
		{
			...
			double result = NumberParser.ParseCore(reader, (char)firstChar, out status,true);
		...
		internal static double CoerceToNumber(string input)
		{
			...
			// Parse the number.
			NumberParser.ParseCoreStatus status;
			double result = NumberParser.ParseCore(reader, (char)firstChar, out status, false);
		...
		internal static double ParseCore(TextReader reader, char firstChar, out ParseCoreStatus status)
		{
			return ParseCore(reader,firstChar,out status,false,true);
		}
		
		internal static double ParseCore(TextReader reader, char firstChar, out ParseCoreStatus status, bool decimalOnly)
		{
			return ParseCore(reader,firstChar,out status,decimalOnly,true);
		}
		...
		internal static double ParseCore(TextReader reader, char firstChar, out ParseCoreStatus status, bool decimalOnly, bool allowES3Octal)
		{
			double result;
