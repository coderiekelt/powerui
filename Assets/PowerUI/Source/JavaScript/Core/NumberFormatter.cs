...
namespace JavaScript{
	...
	internal static class NumberFormatter
	{
		...
		internal static string ToString(double value, int radix, Style style)
		{
			return ToString(value, radix, System.Globalization.CultureInfo.InvariantCulture.NumberFormat, style, 0);
		}
		
		internal static string ToString(double value, int radix, System.Globalization.NumberFormatInfo numberFormatInfo, Style style)
		{
			return ToString(value, radix, numberFormatInfo, style, 0);
		}
