	...
	public static class TypeUtilities
	{
		...
		public static string TypeOf(object obj)
		{
			...
			if (obj is string || obj is ConcatenatedString)
				return "string";
			if (obj is FunctionInstance || obj is System.Reflection.MethodBase)
				return "function";
		...
		public static IEnumerator<string> EnumeratePropertyNames(ScriptEngine engine, object obj)
		{
			...
			IEnumerable<string> set=obj2.PropertyNames(obj);
		...
		/// <summary>
		/// Determines if the given value is a supported JavaScript primitive or is
		/// Extendable.
		/// </summary>
		/// <param name="value"> The value to test. </param>
		/// <returns> <c>true</c> if the given value is a supported JavaScript primitive or is
		/// Extendable; <c>false</c> otherwise. </returns>
